...
// Verificado contra la especificación 1.9.0 (OpenAPI de referencia).  // (microsoft/winget-cli-restsource) :contentReference[oaicite:4]{index=4}
...
// Installer[] desde un singleton ZIP portable (esquema soportado 1.6/1.9). :contentReference[oaicite:5]{index=5}
